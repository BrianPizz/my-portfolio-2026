...
const Hero = () => {
  return (
    <>
      {/* Centered hero content — no absolute, flex handles layout */}
      ...
      {/* Projects CTA anchored at bottom of section — not absolute */}
      <div className="pb-8">
        <a
          href="#projects"
          className="flex flex-col items-center gap-2 text-white/80 hover:text-white transition-colors text-readable"
